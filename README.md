# QuickBite-Express RPC-18-
# From Crisis to Comeback — turning data chaos into clarity. 📊
This project was completed as part of **Resume Project – Challenge 18 from Codebasics**.
...
QuickBite Express operates in 8 different cities – Ahmedabad, Bengaluru, Chennai, Delhi, Hyderabad, Kolkata, Mumbai, and Pune. The platform partners with local eateries and cloud kitchens to deliver a seamless food ordering experience.

## 📌 Problem Statement
June 2025, QuickBite faced a major crisis. A viral social media incident involving food safety viInolations at partner restaurants, combined with a week-long delivery outage during the monsoon season, triggered massive customer backlash. Competitors capitalized with aggressive campaigns, worsening the situation.

## Objective 
To identify the root causes behind declining customer activity, restaurant engagement, and service quality, and to propose data-driven recovery strategies for QuickBite Express.
...
**6. Customer Risk Segmentation** with Suggested Action    
  ...
  Retained	customers- Action : Active customers during crisis	Loyalty & referral rewards   

**7. Restaurant Retention Strategy**

 1. Prioritize High-Risk Partners: Personalized incentives and operational support. 
 2. Tiered Retention Campaigns: Loyalty bonuses for top performers, SLA coaching for medium risk. 
 3. Monitor SLA & Prep Time: Use as early warning indicators for disengagement. 
...
**Key Deliverables**  
Interactive Power BI [Dashboard](https://app.powerbi.com/view?r=eyJrIjoiMTc2YTRlYWEtZDhkMC00N2JjLWI1MjktY2RkN2RmNmNhOTdiIiwidCI6ImM2ZTU0OWIzLTVmNDUtNDAzMi1hYWU5LWQ0MjQ0ZGM1YjJjNCJ9)


Crisis-to-Recovery presentation deck 

City, customer, and restaurant-level insights 
